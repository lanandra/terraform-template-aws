/*
Template configuration for provision Amazon EC2 using latest AMI ID ubuntu 20.04 or amazon-linux-2
...
EC2 will run startup script/user data that rendered from user-data-{image}.sh
